...
exports.createTicket = async (req, res) => {
    ...
    try {
        ...
        if (ticketCreated) {
            ...
            //  Enrich the eamil content



            sendNotification(`Ticket created with id : ${ticketCreated._id}` , "Customer complaint ticket logged.",`${customer.email},${engineer.email},gajelli.kiransai@gmail.com`, "CRM APP");
